...
AddEle("Button", function(parent, props, ...)
	...
	-- Adiciona glow sutil
	local ButtonGlow = Make("Glow", New)
	...
	task.spawn(function()
		while New and New.Parent do
			for i = 0.8, 0.5, -0.05 do
				if not New or not New.Parent then break end
				New.ImageTransparency = i
				task.wait(0.05)
			end
...
AddEle("Shadow", function(parent, props, ...)
	local New = Create("ImageLabel", parent, {
		BackgroundTransparency = 1,
		Image = "rbxassetid://5028857084",
...
function redzlib:MakeWindow(Configs)
	...
	task.spawn(function()
		local GradientObj = MainFrame:FindFirstChildOfClass("UIGradient")
		if GradientObj then
			local rotation = 45
			while MainFrame and MainFrame.Parent do
				rotation = (rotation + 0.5) % 360
				CreateTween({GradientObj, "Rotation", rotation, 2})
				task.wait(2)
			end
		end
	end)
	...
	-- Adiciona efeito de sombra pra dar profundidade
	Make("Shadow", MainFrame)
	
	-- Scan Lines (efeito de TV CRT antiga)
	local ScanLines = Create("Frame", MainFrame, {
	...
	local MainStroke = Make("Stroke", MainFrame, nil, 2) -- Borda mais grossa
	...
	function Window:MakeTab(paste, Configs)
		...
		-- Adiciona glow sutil na tab selecionada
		local TabGlow = Make("Glow", Selected)
		TabGlow.ImageTransparency = FirstTab and 1 or 0.6
		TabGlow.Size = UDim2.new(1, 40, 1, 40)
		...
		local function Tabs()
			...
			CreateTween({TabGlow, "ImageTransparency", 0.6, 0.35})
		end
		...
		function Tab:Disable()
		  self.Enabled = false
			...
			CreateTween({TabGlow, "ImageTransparency", 1, 0.35})
		end
		function Tab:Enable()
			Tabs()
		end
