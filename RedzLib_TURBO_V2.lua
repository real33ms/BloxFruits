	...
	Themes = {
		Arcade = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 5, 25)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(25, 10, 40)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 5, 25))
			}),
			["Color Hub 2"] = Color3.fromRGB(20, 8, 30),
			["Color Stroke"] = Color3.fromRGB(255, 0, 200),
			["Color Theme"] = Color3.fromRGB(0, 255, 255),
			["Color Text"] = Color3.fromRGB(0, 255, 255),
			["Color Dark Text"] = Color3.fromRGB(255, 0, 200)
		},
		Neon = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(10, 10, 35)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(15, 15, 50)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(10, 10, 35))
			}),
			["Color Hub 2"] = Color3.fromRGB(12, 12, 40),
			["Color Stroke"] = Color3.fromRGB(0, 255, 150),
			["Color Theme"] = Color3.fromRGB(255, 50, 255),
			["Color Text"] = Color3.fromRGB(255, 255, 50),
			["Color Dark Text"] = Color3.fromRGB(0, 255, 150)
		},
		Cyberpunk = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(5, 5, 15)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(15, 10, 25)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(5, 5, 15))
			}),
			["Color Hub 2"] = Color3.fromRGB(10, 8, 20),
			["Color Stroke"] = Color3.fromRGB(255, 215, 0),
			["Color Theme"] = Color3.fromRGB(255, 0, 100),
			["Color Text"] = Color3.fromRGB(0, 255, 255),
		...
		RetroWave = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(40, 0, 80)),
			...
			["Color Theme"] = Color3.fromRGB(0, 255, 255),
			["Color Text"] = Color3.fromRGB(255, 50, 255),
			["Color Dark Text"] = Color3.fromRGB(100, 200, 255)
		}
	},
	Info = {
		Version = "2.0.0-TURBO"
...
AddEle("Glow", function(parent, props, ...)
	local args = {...}
	local New = Create("ImageLabel", parent, {
		BackgroundTransparency = 1,
		Image = "rbxassetid://5028857084",
		ImageColor3 = args[1] or Theme["Color Theme"],
	...
	spawn(function()
		while New and New.Parent do
			CreateTween({New, "ImageTransparency", 0.5, 1})
			task.wait(1)
			CreateTween({New, "ImageTransparency", 0.8, 1})
			task.wait(1)
		end
	end)
...
function redzlib:MakeWindow(Configs)
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddColorPicker(Configs)
			...
			})Make("Corner", ColorFrame, UDim.new(0, 4))Make("Stroke", ColorFrame)
			
			local ColorPicker = {}
			local IsOpen = false
			
			local PickerFrame = Create("Frame", Button, {
				Size = UDim2.new(0, 200, 0, 150),
				Position = UDim2.new(1, -10, 0, 25),
				BackgroundColor3 = Theme["Color Hub 2"],
				Visible = false,
				ZIndex = 100
			})Make("Corner", PickerFrame)Make("Stroke", PickerFrame)
			...
			function ColorPicker:Set(NewColor)
				if typeof(NewColor) == "Color3" then
					...
					Funcs:FireCallback(Callback, NewColor)
				end
			end
		...
		function Tab:AddKeybind(Configs)
			...
			local TDesc = Configs.Desc or Configs.Description or ""
			local TDefault = Configs[2] or Configs.Default or Enum.KeyCode.E
			local Callback = Funcs:GetCallback(Configs, 3)
			
			local Button, LabelFunc = ButtonFrame(Container, TName, TDesc, UDim2.new(1, -90))
			...
			local KeybindButton = InsertTheme(Create("TextButton", Button, {
				...
				TextColor3 = Theme["Color Text"],
				Text = TDefault.Name
			}), "Stroke")Make("Corner", KeybindButton, UDim.new(0, 4))
			...
			UserInputService.InputBegan:Connect(function(input, gpe)
				if gpe or IsBinding or input.KeyCode ~= CurrentKey then return end
				Funcs:FireCallback(Callback)
			end)
...
-- ✨ FUNÇÕES TURBO ADICIONADAS ✨
-- Sistema de Rainbow Mode
redzlib.RainbowMode = false
redzlib.RainbowSpeed = 1

function redzlib:EnableRainbow(Speed)
...
function redzlib:DisableRainbow()
	self.RainbowMode = false
end

-- Sistema de Shake (tremor na UI)
function redzlib:ShakeUI(Intensity, Duration)
	local MainFrame = self.Instances.Main
	...
	spawn(function()
		while tick() - StartTime < (Duration or 0.5) do
			...
			MainFrame.Position = OriginalPos + UDim2.fromOffset(Offset.X, Offset.Y)
			task.wait(0.03)
		end
...
function redzlib:AddParticles(ParentFrame)
	local ParticlesHolder = Create("Frame", ParentFrame, {
		Size = UDim2.new(1, 0, 1, 0),
		BackgroundTransparency = 1,
		ZIndex = -1
	})
	...
	for i = 1, 15 do
		local Particle = Create("Frame", ParticlesHolder, {
		...
		spawn(function()
			while true do
				...
				CreateTween({Particle, "Position", NewPos, math.random(3, 8)})
